window.employeeData = [{
    ...
    "TitleOfCourtesy": "Ms.",
    "BirthDate": ej.format(new Date(-664743600000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(704692800000), "MM/dd/yyyy"),
    ...
    "ReportsTo": 2,
    "PhotoPath": "//accweb/emmployees/davolio.bmp"
},
{
    "EmployeeID": 2,
    "LastName": "Fuller",
    ...
    "TitleOfCourtesy": "Dr.",
    "BirthDate": ej.format(new Date(-563828400000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(713764800000), "MM/dd/yyyy"),
    ...
    "ReportsTo": null,
    "PhotoPath": "//accweb/emmployees/fuller.bmp"
},
{
    "EmployeeID": 3,
    "LastName": "Leverling",
    ...
    "Title": "Sales Representative",
    "TitleOfCourtesy": "Ms.",
    "BirthDate": ej.format(new Date(-200088000000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(702104400000), "MM/dd/yyyy"),
    ...
    "ReportsTo": 2,
    "PhotoPath": "//accweb/emmployees/leverling.bmp"
},
{
    "EmployeeID": 4,
    "LastName": "Peacock",
    ...
    "Title": "Sales Representative",
    "TitleOfCourtesy": "Mrs.",
    "BirthDate": ej.format(new Date(-1018814400000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(736401600000), "MM/dd/yyyy"),
    ...
    "ReportsTo": 2,
    "PhotoPath": "//accweb/emmployees/peacock.bmp"
},
{
    "EmployeeID": 5,
    "LastName": "Buchanan",
    ...
    "Title": "Sales Manager",
    "TitleOfCourtesy": "Mr.",
    "BirthDate": ej.format(new Date(-468010800000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(750830400000), "MM/dd/yyyy"),
    ...
    "ReportsTo": 2,
    "PhotoPath": "//accweb/emmployees/buchanan.bmp"
},
{
    "EmployeeID": 6,
    "LastName": "Suyama",
    ...
    "Title": "Sales Representative",
    "TitleOfCourtesy": "Mr.",
    "BirthDate": ej.format(new Date(-205185600000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(750830400000), "MM/dd/yyyy"),
...
},
{
    ...
    "Title": "Sales Representative",
    "TitleOfCourtesy": "Mr.",
    "BirthDate": ej.format(new Date(-302731200000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(757486800000), "MM/dd/yyyy"),
...
},
{
    ...
    "TitleOfCourtesy": "Ms.",
    "BirthDate": ej.format(new Date(-377982000000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(762843600000), "MM/dd/yyyy"),
...
},
{
    ...
    "Title": "Sales Representative",
    "TitleOfCourtesy": "Ms.",
    "BirthDate": ej.format(new Date(-123966000000), "MM/dd/yyyy"),
    "HireDate": ej.format(new Date(784875600000), "MM/dd/yyyy"),
