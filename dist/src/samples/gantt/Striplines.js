export class StripLines {
  constructor() {
    this.striplines = [
                    ...
                    { day: '02/11/2017', label: 'Planning Complete', lineStyle: 'dotted', lineColor: 'Darkblue', lineWidth: 2 },
                    { day: '02/18/2017', label: 'Design Complete', lineStyle: 'dotted', lineColor: 'Darkblue', lineWidth: 2 },
                    { day: '03/03/2017', label: 'Implementation Complete', lineStyle: 'dotted', lineColor: 'Darkblue', lineWidth: 2 },
                    { day: '03/11/2017', label: 'Final Delivery', lineStyle: 'dotted', lineColor: 'Darkblue', lineWidth: 2 }
    ];
